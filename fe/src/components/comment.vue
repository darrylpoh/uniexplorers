...
<div class="user-question">
    ...
    <img class="avatar" src="../../public/Profile Female.png" alt="">
    <div class="question-container">
        ...
        <li>
            <svg v-if="upvoteFill" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" @click="updateVote('upvote')" class="thumbs-icon">
            ...
            <svg v-else width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" @click="updateVote('upvote')" class="thumbs-icon">
            ...
            <span>{{ commentData.num_likes + upvoteFill ? 1 : 0 }}</span>
        </li>
        <li>
            <svg v-if="downvoteFill" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" @click="updateVote('downvote')" class="thumbs-icon">
            ...
            <svg v-else width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" @click="updateVote('downvote')" class="thumbs-icon">
        ...
        <!-- Craft Comment -->
        <div v-if="reply" class="create-section mt-5">
        <div>
