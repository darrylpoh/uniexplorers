...
<template>
    <form class="space-y-6 h-133 z-10" action="#">
            <div>
                <label for="email" :class="email ? 'hidden' : 'block'" class="transition-all block mb-2 text-sm font-medium text-gray-900 text-darkgreen">Your email</label>
