        ...
        <div class="w-full mb-5">
          <div class="mb-4 ml-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
              ...
              <div class="dark:bg-gray-800 ">
                  <textarea 
                  id="editor" rows="8" :class="['block', 'w-full','text-sm', 'text-gray-800' ,'bg-white', 'border-0', 'rounded-lg', 'dark:bg-gray-800' , 'dark:text-white', 'px-4', 'py-2', 'dark:placeholder-gray-400', focus ? 'h-48' : 'h-32', 'post-actions']" placeholder="Ask away!" required v-model="newQuestion" @focus="focus = true">
                  </textarea>
              </div>
              <div class="flex items-center justify-between px-3 py-2 border-b dark:border-gray-600" v-if="focus">
                <!-- WYSISWG items -->
                ...
                <button @click="createQuestion()" class="text-sm font-medium text-center text-white bg-darkgreen rounded-lg create-button cursor-pointer">
                    Publish Post
                </button>
              </div>
          </div>
